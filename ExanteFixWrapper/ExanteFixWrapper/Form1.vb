    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles SubscribreButton0.Click
        ...
        If (isOnline) Then
            Try
                ...
                pageList(Tabs.SelectedIndex).bufferTrades10sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades15sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades30sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades60sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades300sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades600sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades900sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades1800sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).bufferTrades3600sec.StartWritingData(ExanteIDTextBox0.Text)
                pageList(Tabs.SelectedIndex).TabId = Tabs.SelectedIndex
                Dim firstPointNsec As New PointTradesNsec()
                pageList(Tabs.SelectedIndex).cp.pointsTrades5sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades10sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades15sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades30sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades60sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades300sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades600sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades900sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades1800sec.Add(firstPointNsec)
                pageList(Tabs.SelectedIndex).cp.pointsTrades3600sec.Add(firstPointNsec)
